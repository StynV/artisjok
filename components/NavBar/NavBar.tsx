const NavBar = ({ handleNavBarClick }: { handleNavBarClick: (index: number) => void; }) => (
    <nav className='bg-white bg-opacity-50 fixed w-full z-20 top-0 start-0'>
        <ul className='flex items-center justify-center mx-auto p-4'>
            ...
            <li onClick={() => handleNavBarClick(1)} className='py-2 px-3 text-black md:text-2xl hover:text-blue-700 cursor-pointer'>Welkom</li>
