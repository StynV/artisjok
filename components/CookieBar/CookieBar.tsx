    ...
    >
      <div className="fixed bottom-0 left-0 right-0 flex md:flex-row flex-col items-center justify-between px-4 py-8 bg-gray-100">
        <span className="text-black text-base mr-16 mb-5 md:mb-0">
          Deze website gebruikt cookies om de user experience hoog te houden.
          Door onze website te gebruiken kom je hiermee overeen.
        </span>
        <div>
          <button
            className="bg-green-500 py-2 px-8 rounded text-white mr-5"
